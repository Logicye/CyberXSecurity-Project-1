...
Menu() {
      printf ("%d%s", ' _____ _     _  __  ___           _        _ _')
      printf ("%d%s", '| ____| |   | |/ / |_ _|_ __  ___| |_ __ _| | |')
      printf ("%d%s", '|  _| | |   | ' /   | || '_ \/ __| __/ _` | | |')
      printf ("%d%s", '| |___| |___| . \   | || | | \__ \ || (_| | | |')
      printf ("%d%s", '|_____|_____|_|\_\ |___|_| |_|___/\__\__,_|_|_|')
